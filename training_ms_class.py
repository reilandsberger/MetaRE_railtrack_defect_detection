...
range_defect = torch.load(RAILDEFECT_DIR / "range_2class.pt")
depth_defect = torch.load(RAILDEFECT_DIR / "depth_2class.pt")
...
psi_ms = torch.load(RAILDEFECT_DIR / "psi_ms_2class.pt").to(torch.complex64)
